...
function processJSON(jsonArr) {
    ...
    for(key in collective) {
        console.log(collective[key]);
        for(key2 in collective[key]) {
            console.log(collective[key][key2]);
        }
    }
    //return;
    ...
    console.log("KEYS OF REFINED COLLECTIVE");
    console.log(Object.keys(refinedCollective));
    ...
    console.log("length of collectiveArr: " + collectiveArr.length);
